...
[Download v1.8 Setup (.msi)](https://github.com/dankrusi/WindowsVirtualDesktopHelper/releases/download/v1.8/WindowsVirtualDesktopHelper.Setup.v1.8.msi) | 
[Download v1.8 Executable (.zip)](https://github.com/dankrusi/WindowsVirtualDesktopHelper/releases/download/v1.8/WindowsVirtualDesktopHelper.Executable.v1.8.zip)
...
[Download WindowsVirtualDesktopHelper Setup v1.8.msi](https://github.com/dankrusi/WindowsVirtualDesktopHelper/releases/download/v1.8/WindowsVirtualDesktopHelper.Setup.v1.8.msi)
...
[Download WindowsVirtualDesktopHelper Executable v1.8.zip](https://github.com/dankrusi/WindowsVirtualDesktopHelper/releases/download/v1.8/WindowsVirtualDesktopHelper.Executable.v1.8.zip)
